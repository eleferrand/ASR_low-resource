'''
 ...
 # @ Description: Script to train a HuBERT ASR model. The script takes as argument the path to a folder 
...
def train(data_path, lang, model_type):
    ...
    if model_type == 'hubert-large-ll60k':
        model_name = "facebook/hubert-large-ll60k"
    elif model_type == 'hubert-xlarge-ll60k':
